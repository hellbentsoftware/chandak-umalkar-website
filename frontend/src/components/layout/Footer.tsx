  ...
  <footer className="w-full bg-gray-900 text-gray-200 py-8 mt-12">
    <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-6">
      ...
      <div className="text-center md:text-left">
        ...
        <p className="text-xs mt-2 text-gray-400">Made with ❤️</p>
        <p className="text-xs mt-2 text-gray-400">&copy; {new Date().getFullYear()} Hellbent Software & Educational Services LLP. All rights reserved.</p>
      </div>
      {/* Navigation */}
