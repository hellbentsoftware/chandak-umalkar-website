  ...
  React.useEffect(() => {
    const fetchStats = async () => {
      try {
        ...
        toast({ title: 'Error', description: 'Could not load statistics', variant: 'destructive' });
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="text-sm text-gray-500 mb-2 flex items-center gap-2">
              ...
              <span className="inline-block bg-gray-100 p-1 rounded-full">
                <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a4 4 0 0 0-3-3.87M9 20H4v-2a4 4 0 0 1 3-3.87m9-4a4 4 0 1 0-8 0 4 4 0 0 0 8 0z" /></svg>
              </span>
            </div>
            <div className="text-3xl font-bold text-foreground mb-1">{stats.loading ? '...' : stats.totalUsers}</div>

          </div>
          <div className="bg-white rounded-lg shadow p-6 cursor-pointer hover:bg-purple-50 transition" onClick={() => setActiveTab('documents')}>
            <div className="text-sm text-gray-500 mb-2 flex items-center gap-2">
              Documents Uploaded
              <span className="inline-block bg-purple-100 p-1 rounded-full">
                <svg className="w-4 h-4 text-purple-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 4H7a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h7l5 5v11a2 2 0 0 1-2 2z" /></svg>
              </span>
            </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="text-sm text-gray-500 mb-2 flex items-center gap-2">
              ...
              <span className="inline-block bg-orange-100 p-1 rounded-full">
                <svg className="w-4 h-4 text-orange-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M3 3v18h18M3 9h18M9 21V9" /></svg>
              </span>
            </div>
